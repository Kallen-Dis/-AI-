...
class MapClientAdapter:
    ...
    def __init__(self, map_tools: BaiduTools):
        self._tools = map_tools
...
class TravelPlanningOrchestrator:
    ...
    async def orchestrate(self, user_intent: UserIntent) -> Dict[str, Any]:
        ...
        print(f"预算: {user_intent.budget}元")
        print("="*60 + "\n")
    ...
    async def _execute_first_iteration(self, context: PlanningContext) -> None:
        ...
        try:
            ...
            print(f"   预算分配完成: 共{total:.0f}元 / 总预算{context.user_intent.budget:.0f}元")
